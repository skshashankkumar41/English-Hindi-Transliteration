...
def get_loader(root_path, batch_size = 32,shuffle = True, num_workers = 0,pin_memory = True,prediction=False):
    trainDataset = TranslateDataset(root_path + 'train_df.xlsx')
    valDataset = TranslateDataset(root_path + 'validate_df.xlsx')
    testDataset = TranslateDataset(root_path + 'test_df.xlsx')
