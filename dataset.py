...
# trainDataset = TranslateDataset('train_data.xlsx')

# print(trainDataset.hin_vocab.stoi.keys())
# print(trainDataset.hin_vocab.encode("आभिजात"))
